...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ManticoreSdk.KApi = factory(root.ManticoreSdk.ApiClient);
  }
  ...
  /**
   * Constructs a new KApi.
   * @alias module:api/KApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the getV2K operation.
     * @callback module:api/KApi~getV2KCallback
     ...
     * @param {module:api/KApi~getV2KCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.getV2K = function(market, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'market' is set
      if (market === undefined || market === null) {
        throw new Error("Missing the required parameter 'market' when calling getV2K");
      }
